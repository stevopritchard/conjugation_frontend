...
class Practise extends React.Component {
  ...
  getVerbs() {
    let tense =
      this.state.selectedTenses[
        Math.floor(Math.random() * this.state.selectedTenses.length)
      ];
  ...
  selectTense = (e) => {
    if (e.target.checked === true) {
      this.setState({
        selectedTenses: this.state.selectedTenses.concat(e.target.id),
      });
    } else if (e.target.checked === false) {
      this.setState({
        selectedTenses: this.state.selectedTenses.filter(
        ...
        {testActive === true ? (
          ...
          <Card className="practiseCard">
            <Card.Body>
              ...
              <Button variant="primary" onClick={() => this.startTest(true)}>
                Begin
              </Button>
            </Card.Body>
          </Card>
